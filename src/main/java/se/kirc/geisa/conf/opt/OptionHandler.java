...
/**
 * This interface specifies the bare necessities for an Option Handler.
 * 
 ...
 * 
 */
public interface OptionHandler extends Serializable {
	/**
	 ...
	 *             value.
	 */
	void handle(CommandLine cmd) throws OptionHandlerException;
}
